...
const EditPublicationMeta: React.FC<MetaEditorProps> = function ({
  obj,
  create,
  onChange,
  validators,
        ...
        <InputGroup
          ...
          onChange={(evt: React.FormEvent<HTMLElement>) => {
            onChange({
              ...
              title: {
                ...publication.title,
                [lang.default]: (evt.target as HTMLInputElement)
                  .value as string,
              },
            });
          }}
        ...
        helperText={
          <ul>
            ...
            {!validationErrors.url && (publication.url || "") !== "" ? (
              <li>
                <a
                  onClick={() => shell.openExternal(publication.url as string)}
                >
        ...
        <FormGroup
          ...
          helperText={
            <ul>
              ...
              />
              <li>
                Use uppercase English string as publication ID: e.g., BUREAUFAX.
              </li>
              <li>
                Choose an ID consistent with publication URL on ITU website, if
                possible.
              </li>
